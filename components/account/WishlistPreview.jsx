  ...
  return (
    <div className="bg-surface-white p-8 border border-outline-variant rounded shadow-sm flex-1">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          className="font-label-caps text-label-caps text-regal-gold hover:text-deep-emerald uppercase transition-colors"
          to="/wishlist"
        >
          View All
        </Link>
        ...
        <div className="flex gap-4">
          {displayItems.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="w-1/2 flex flex-col gap-2 group cursor-pointer"
              >
