    ...
    <div className="px-5 py-6 md:px-8 md:py-8 lg:px-10">
      ...
      <div className="mb-8 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          <button className="flex items-center justify-center inline-flex items-center rounded-xl border border-[#E7DFD3] bg-white px-5 py-3 text-sm font-semibold text-[#114232] shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#C99742] hover:bg-[#FCF9F7]">
                  ...
                  return (
                    <div key={item._id} className="flex items-center justify-between border-b border-surface-variant pb-3 last:border-0 last:pb-0">
                      <div>
                        ...
                        <p className="font-label-sm text-label-sm text-[#66756F] mt-1">SKU: {product.sku || 'â€”'}</p>
                      </div>
